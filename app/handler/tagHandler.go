...
func DeleteImagetagHandler(w http.ResponseWriter, r *http.Request) {
	if r.Method == http.MethodOptions {
		util.EnableCorsResponse(&w)
	}
	if r.Method == http.MethodPost {
...
func ReceivedImageTagHandler(w http.ResponseWriter, r *http.Request) {
	if r.Method == http.MethodOptions {
		util.EnableCorsResponse(&w)
	}
	if r.Method == http.MethodPost {
...
func GetImageTagHandler(w http.ResponseWriter, r *http.Request) {
	util.EnableCors(&w)
