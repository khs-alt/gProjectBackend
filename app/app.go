...
func SetupRouter() *mux.Router {
	...
	authRoutes.HandleFunc("/getVideoIndexCurrentPage", handler.GetUserCurrentPage)
	authRoutes.HandleFunc("/getImageIndexCurrentPage", handler.GetUserCurrentImagePage)
